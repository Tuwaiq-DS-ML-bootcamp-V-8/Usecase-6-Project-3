...
st.markdown("""
<div class="text">
أول شي حب سعود يوضح لراكان وين الأحياء اللي أسعارها غالية، وقال له: "هذي المناطق تناسب القهاوي الفخمة اللي تبغى تستهدف الزبائن المرفّهين". أسعار الأراضي تختلف من حي لحي، حسب الموقع والبنية التحتية والطلب.
</div>
</div>
""", unsafe_allow_html=True)
